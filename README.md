...
- ⏯️ **Passenger controls**: large, auto-hiding previous, play/pause, and next controls target the exact active Spotify device and stay hidden when that device rejects Web API commands.
